...
Работа выполнена корректно, программа в нужном порядке выводит сообщения (рис. [-@fig:007]).
...
Использую свой первый вариант  из предыдудщей лабораторной работы. Возвращаю операнд к функции в программе и изменяю ее так, чтобы она выводила переменную с наименьшим значением (рис. [-@fig:013]).
