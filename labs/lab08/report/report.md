...
Копирую в созданный файл программу из листинга и запускаю программу, она показывает работу циклов в NASM (рис. [-@fig:003]).

![Запуск программы](image/3.png){#fig:003 width=70%}

Заменяю программу изначальную так, что в теле цикла изменяю значение регистра ecx (рис. [-@fig:004]).
...
Пишу программму, которая будет находить сумма значений для функции f(x) = 2x+15,
которая совпадает с моим первым варинтом (рис. [-@fig:014]).
